...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', default='./image_sets/sofa4/*.jpg', type=str, help='Input filename or folder.')
    parser.add_argument('--depth', default='./image_sets/sofa4/*.png', type=str, help='Trained Keras model file.')
    parser.add_argument('--mode', default='fpfh', type=str, help='method of reconstruction')
    parser.add_argument('--voxel', default=20, type=int, help='method of reconstruction')
    parser.add_argument('--inter', default='yes', type=str, help='method of reconstruction')
    ...
    if args.mode == "fpfh":
        ...
        rec.fpfh(point_clouds, args.voxel, fast, dump, args.folder, args.name, poisson, plot)
