...
def fpfh(point_clouds, dump=False, dump_folder=None, image_set_name=None, poisson=True):
    ...
    chain_transformation(pcds, all_results, dump, dump_folder, image_set_name, poisson)
...
def chain_transformation(pcds, transformations, dump=False, dump_folder=None, image_set_name=None, poisson=True):
    ...
    if poisson:
        mesh = apply_poisson(combined_pcd)
        name = 'poisson'
    else:
        mesh = apply_ball_point(combined_pcd)
        name = 'ball_point'
...
def rigid3d_proc(point_clouds, rgb_images, depth_images, np_kps_pre_img, cv_kps_pre_img, cv_des_pre_img, dump=False, dump_folder=None, image_set_name=None, poisson=True):
    pcds = make_pcds(point_clouds, dump, dump_folder, image_set_name)
...
def homo3d_proc(point_clouds, rgb_images, depth_images, np_kps_pre_img, cv_kps_pre_img, cv_des_pre_img, dump=False, dump_folder=None, image_set_name=None, poisson=True):
    pcds = make_pcds(point_clouds, dump, dump_folder, image_set_name)
...
if __name__ == "__main__":
    ...
    if (args.mode == "fpfh"):
        ...
        rigid3d_proc(point_clouds, rgb_images, depth_images, np_kps_pre_img, cv_kps_pre_img, cv_des_pre_img, dump, args.folder, args.name, poisson)
    else:
        homo3d_proc(point_clouds, rgb_images, depth_images, np_kps_pre_img, cv_kps_pre_img, cv_des_pre_img, dump, args.folder, args.name, poisson)
