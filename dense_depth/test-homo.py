...
H_matrix = homo3d.homo_rigid_transform_3D(get_3d_kps(input_voxels[1], m_kp2), get_3d_kps(input_voxels[0], m_kp1) )
print(H_matrix)

#affine(get_3d_kps(input_voxels[0], m_kp1), get_3d_kps(input_voxels[1], m_kp2))

new_3d_pts = [input_voxels[0]]
new_3d_pts.append(get_transformed_points(input_voxels[1], H_matrix))
